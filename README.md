...
The pipeline's purpose is to create an Athena table from a S3 bucket in APDP, so that the data can be ingested by [CaDeT](https://github.com/moj-analytical-services/create-a-derived-table).
